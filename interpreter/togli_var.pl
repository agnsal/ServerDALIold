...
leggiFile_var(Infile,Txt) :-			%apertura file,lettura righe
	...
	atom_concat(Infile,'.pl',File),	%...sostituito col seg. piu'' casereccio
	see(File),   
	leggiChars_var(Txt), !,
	seen.
...
leggiFile_var_ple(Infile,Txt) :-			%apertura file,lettura righe
	...
	atom_concat(Infile,'.ple',File),	%...sostituito col seg. piu'' casereccio
	see(File),   
	leggiChars_var(Txt), !,
	seen.
...
%GESTIONE LEARNING
%%Modificato anche lui... DA TESTARE SE FUNZIONA PERò!
...
leggiFile_var_clause(Infile,Txt) :-			%apertura file,lettura righe
					%e chiusura file
		%...sostituito col seg. piu'' casereccio
	see(Infile), 
	leggiChars_var(Txt), !,
	seen.
