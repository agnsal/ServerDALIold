...
% Secondo me client e lists sono inutili.

% Facciamo partire un linda server in sicstus con linda/1
%
...
%see\1 apre uno stream, mentre seen lo chiude
%out\1 scrive sulla lavagna
